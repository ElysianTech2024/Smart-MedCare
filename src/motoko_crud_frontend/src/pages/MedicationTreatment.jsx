// src/pages/MedicationTreatment.js
...
function MedicationTreatment() {
  ...
  const handleGoToForm = () => {
    navigate('/medication-treatment-form');
  };
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 bg-blue-50 p-8 ml-64">
        <h1 className="text-3xl font-bold mb-8">Medication and Treatment</h1>
