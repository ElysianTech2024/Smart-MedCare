      ...
      >
        <div className="max-w-md w-full p-8 bg-white bg-opacity-90 rounded-lg shadow-lg">
          ...
          <div className="text-center mt-4">
            <p className="text-sm text-gray-600">Don't have an account? <Link to="/register-hospital" className="font-semibold text-indigo-600 hover:text-indigo-500">Register as a Hospital</Link></p>
          </div>
        </div>
      </div>
    </>
